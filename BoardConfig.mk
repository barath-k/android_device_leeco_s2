...
# Bionic
TARGET_LD_SHIM_LIBS := /system/vendor/lib64/lib-imsvt.so|libshims_ims.so:/system/bin/mm-qcamera-daemon|libshims_camera.so:/system/vendor/lib64/libril-qc-qmi-1.so|libshims_rild_socket.so:/system/vendor/lib64/libizat_core.so|libshims_get_process_name.so
